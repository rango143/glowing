...
EbNo_Output = EbNo_Input +10*log10((2/3)*log2(4)); %code Eb/No rate
...
for n = 1:length(EbNo_Output)
    ...
    fprintf('code rate is 2/3, Eb/No is %g\n',EbNo_Input(n));
...
title('BER vs Eb/No for QPSK at 2/3');
ylabel('BER');

save('QPSK2.mat','EbNo_Input','BER','uncoded_Q');%save results